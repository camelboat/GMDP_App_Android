                ...
                MDCard:
                    ...
                    BoxLayout:
                        ...
                        MDSeparator:
                            height: dp(1)
                        MDLabel:
                            text: str(app.current_temperature_setting)+u'\N{DEGREE SIGN}'
                            theme_text_color: 'Secondary'
                            font_style:"Title"
                            halign: 'center'
                            font_size: '20pt'
...
class KitchenSink(App):
    ...
    current_temperature_setting = ObjectProperty()
    #webview = None
    ...
    def show_example_snackbar(self, snack_type):
        if snack_type == 'on':
            ...
            Snackbar(text="This is a very very very very very ver very long snackbar!").show()

    def get_temperature(self):
        r = requests.get(baseURL_Channel_get)
        data = json.loads(r.text)
        self.current_temperature_setting = 25
        self.temperature = str(data['feeds'][0]['field1'][1:]) + u'\N{DEGREE SIGN}'

    def increase_temperature(self):
        self.current_temperature_setting += 1
    ...
    def get_temperature_plot(self):
        webbrowser.open(
           'https://thingspeak.com/channels/723513/charts/1?bgcolor=%23ffffff&color=%23d62020&dynamic=true&results=60&type=line&update=15')
        # self.create_webview()
    ...
    #     webview.loadUrl('https://thingspeak.com/channels/723513/charts/1?bgcolor=%23ffffff&color=%23d62020&dynamic=true&results=60&type=line&update=15')
    #     self.detach_webview()
